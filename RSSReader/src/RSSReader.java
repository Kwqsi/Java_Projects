...
//if statements for when linkIndex exists or does not, followed by statements for when title exists or does not, and description
        out.println("<td>");
    ...
    public static void main(String[] args) {
        ...
        SimpleWriter file = new SimpleWriter1L("yahoo.html");
//prompting user
        out.print("Enter RSS: ");
        String url = in.nextLine();
        //initialize xml from user input
