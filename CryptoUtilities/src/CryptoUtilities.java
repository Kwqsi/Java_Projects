...
public final class CryptoUtilities {
    ...
    /**
     * Useful constant, not a magic number: 3 and 4.
     */
    ...
    public static boolean isEven(NaturalNumber n) {
        ...
        //if lastdigit is even return true
        if (lastDigit % 2 == 0) {
            isEven = true;
        }
        //restore
...
//      assert m.compareTo(new NaturalNumber2(1)) > 0 : "Violation of: m > 1";
        ...
        NaturalNumber copyN = new NaturalNumber2();
        ...
        if (p.compareTo(zero) < 1) {
            ...
            //even
            if (isEven(p)) {
                NaturalNumber pDivide2 = new NaturalNumber2();
                pDivide2.copyFrom(p);
                pDivide2.divide(two);
                powerMod(n, pDivide2, m);
            ...
            //odd
                ...
                NaturalNumber copyN2 = new NaturalNumber2();
                copyN2.copyFrom(n);
                NaturalNumber pDivide2 = new NaturalNumber2(p);
                pDivide2.divide(two);
                powerMod(n, pDivide2, m);
                copyN.copyFrom(n);
                n.multiply(copyN);
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        //using powerMod to solve equations
        powerMod(w, p, n);
        powerMod(wCopy, nCopy, n);
//if case for changing witness
        if (w.equals(one) || !wCopy.equals(one)) {
...
//for loop for fifty random numbers
            for (int i = 0; i < fifty && isPrime; i++) {
                n.subtract(four);
                NaturalNumber rand = randomNumber(n);
                n.add(four);
                rand.add(two);
...
//            isPrime = !isWitnessToCompositeness(new NaturalNumber2(2), n);
    ...
    public static void generateNextLikelyPrime(NaturalNumber n) {
        ...
        NaturalNumber two = new NaturalNumber2(2);
//if the number is even increment by 1 to make it odd
        if (isEven(n)) {
            n.increment();
        }
        //add two to continue it being odd
        while (!isPrime2(n)) {
            n.add(two);
        }
